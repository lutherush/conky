...
--Temperatura del CPU
  ...
  inverse_arc=false,
  border_size=2,
  fg_colour1={{0,0xffffff,0.1},{0.5,0x00ff00,1},{1,0xffffff,0.1}},
  fg_colour2={{0,0xffffff,0.1},{0.5,0xff0000,0.9},{1,0xffffff,0.1}},
  bg_colour1={{0,0xffffff,0.1},{0.5,0x0000ff,0.5},{1,0xffffff,0.1}},
  bg_colour2={{0,0xffffff,0.1},{0.5,0x00ffd0,0.5},{1,0xffffff,0.1}},
  bd_colour1={{0,0xffffff,0.1},{0.5,0xffffff,0.2},{1,0xffffff,0.1}},
  bd_colour2={{0,0xffffff,0.1},{0.5,0x00ffd0,0.1},{1,0xffffff,0.1}},
  background=true,  
  },
...
-----CLOCK
{
  ...
  inverse_arc=false,
  border_size=2,
  fg_colour1={{0,0xffffff,0.1},{0.5,0xff6800,1},{1,0xffffff,0.1}},
  fg_colour2={{0,0xffffff,0.1},{0.5,0xff0000,1},{1,0xffffff,0.1}},
  bg_colour1={{0,0xffffff,0.1},{0.5,0x0000ff,0.5},{1,0xffffff,0.1}},
  bg_colour2={{0,0xffffff,0.1},{0.5,0x00ffd0,0.5},{1,0xffffff,0.1}},
  bd_colour1={{0,0xffffff,0.1},{0.5,0xffffff,0.2},{1,0xffffff,0.1}},
  bd_colour2={{0,0xffffff,0.1},{0.5,0x00ffd0,0.1},{1,0xffffff,0.1}},
...
function draw_ring(t)
	...
	local function setup(t)
		...
		if t.end_angle==nil then t.end_angle=270 end
		...
		if t.gap_sectors==nil then t.gap_sectors=0.55 end 
