...
--CPU SETTINGS
     {
        ...
        angle=-90,
        orientation="nn",
               colour={{0,0x00FF00,0.5},
                {0.5,0x00FFFF,0.7},
                {1,0x00FF00,0.5}
                },
        },   
   {
        text='P=' ..conky_parse("${cpu}%"),
        x=42,
        y=94,
        font_name="handelgothic bt",
        font_size=11,
               colour={{0,0x00FF00,0.5},
                {0.5,0x00FFFF,0.7},
                {1,0x00FF00,0.5}
   ...
   {
        text='' ..conky_parse("${execi 4 sensors | grep -A 0 'temp2' | cut -c15-18}°C"),
        x=112,
        y=100,
        font_name="handelgothic bt",
        font_size=11,
...
-- memory settings
   ...
   {
        text='SWAP=' ..conky_parse("${swapperc}%"),
        x=40,
        y=194,
        font_name="handelgothic bt",
        font_size=9,
